...
var debug = require("debug")("nodemac:agent");
...
function NodeAgent(baseinfo, agentKey){
    ...
    debug("new agent:", this.baseinfo.node_id, this.identity);
    this.settings = {};
}
...
NodeAgent.prototype.add_to_master = function(master_info){
    ...
    this.master_req.on("message",(buff)=>{
        ...
        if(msg.route == "reg_ok"){
            ...
            debug(this.baseinfo.node_id, "reg to master ok");
            return;
        }
